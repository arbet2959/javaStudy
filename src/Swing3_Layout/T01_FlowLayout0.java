...
public class T01_FlowLayout0	 extends JFrame {   //flowLayout 차곡차곡하나씩
	private JButton btnOk, btnExit, btnAnswer1, btnAnswer2, btnAnswer3, btnInput;
	private JLabel lblName;
	public T01_FlowLayout0() {
		...
		setLayout(new FlowLayout()); //레이아웃세팅
		...
		btnAnswer3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(ans ==2) JOptionPane.showMessageDialog(null, "취소합니다.","취소창",JOptionPane.WARNING_MESSAGE);
			}
		});
		...
		btnAnswer1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(ans == 2) JOptionPane.showMessageDialog(null, "취소버튼을 누르셨습니다.","취소창",JOptionPane.WARNING_MESSAGE);
			}
		});
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			@Override
			public void run() {
				T01_FlowLayout0 t01 = new T01_FlowLayout0();
				t01.setVisible(true);
			}
		});
	}
