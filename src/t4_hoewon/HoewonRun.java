...
//					name =sc.next();
//					System.out.println("회원 나이을 입력하세요?");
//					int age =sc.nextInt();
//					System.out.println("회원 주소을 입력하세요?");
//					String address =sc.next();
//					System.out.println("회원 성별을 입력하세요?(1:남자, 2:여자");
//					int gender =sc.nextInt();
//					dao.setHoewonInput(name,age,address,gender);
					
					vo = new HoewonVO();
//					while(true) {
//						System.out.println("회원 idx를 입력하세요");
//						int idx = sc.nextInt();
//						vos = dao.getSearchidx(idx);
//						if(vos.get(0)!=null) {System.out.println("중복된 idx입니다"); continue; }
//						break;
//					} 
